...
[![Build Status](https://api.travis-ci.org/${GIT_PROJECT}/${PLUGIN_NAME}.png?branch=master)](https://travis-ci.org/NetCommons3/${PLUGIN_NAME})
[![Coverage Status](https://coveralls.io/repos/${GIT_PROJECT}/${PLUGIN_NAME}/badge.png?branch=master)](https://coveralls.io/r/NetCommons3/${PLUGIN_NAME}?branch=master)
