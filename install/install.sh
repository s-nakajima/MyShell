...
echo "php ${CURDIR}/insert_user.php ${DBNAME}"
php ${CURDIR}/insert_user.php ${DBNAME}
...
echo "php ${CURDIR}/insert_user_post.php ${DBNAME}"
php ${CURDIR}/insert_user_post.php ${DBNAME}

echo "chown ${OWNER}:${GROUP} -R ${NC3DIR}/app"
chown ${OWNER}:${GROUP} -R ${NC3DIR}/app

plugins="`ls ${NC3DIR}/app/Plugin`"
echo "`which php` ${CURDIR}/create_plugin_data.php"
for plugin in ${plugins}
do
	`which php` ${CURDIR}/create_plugin_data.php ${plugin} $DBNAME
done
